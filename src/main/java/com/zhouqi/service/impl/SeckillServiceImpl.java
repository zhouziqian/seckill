...
import com.zhouqi.dao.SeckillDao;
import com.zhouqi.dao.SuccessKilledDao;
...
import com.zhouqi.exception.SeckillException;
...
public class SeckillServiceImpl implements SeckillService {
    ...
    private final String salt="jkasdjlkajiqwjdqw";
    ...
    public SeckillExecutionDto executeSeckill(long seckillId, long userPhone, String md5) throws SeckillException, RepeatKillException, SeckillCloseException {
        if(md5==null||!md5.equals(getMD5(seckillId))){
            throw new SeckillException("seckill data rewrite");//秒杀数据被篡改
        }
        //执行秒杀逻辑:减库存+增加购买明细
        Date nowTime=new Date();
        try {
